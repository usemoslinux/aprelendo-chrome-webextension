...
document.addEventListener('click', (e) => {
  chrome.runtime.sendMessage({ lang: e.target.id }, (e) => {
    window.close();
  });
});
...
document.addEventListener('DOMContentLoaded', (e) => {
  ...
  chrome.storage.sync.get(['show_ar', 'show_zh', 'show_nl', 'show_en', 'show_fr',
    ...
    if (res.show_ar || typeof res.show_ar === 'undefined') {
      ...
      element.textContent = chrome.i18n.getMessage('arabicName');
    ...
    if (res.show_zh || typeof res.show_zh === 'undefined') {
      ...
      element.textContent = chrome.i18n.getMessage('chineseName');
      popup.appendChild(element);
    }
    ...
    if (res.show_nl || typeof res.show_nl === 'undefined') {
      ...
      element.textContent = chrome.i18n.getMessage('dutchName');
      popup.appendChild(element);
    }
    ...
    if (res.show_en || typeof res.show_en === 'undefined') {
      ...
      element.textContent = chrome.i18n.getMessage('englishName');
      popup.appendChild(element);
    }
    ...
    if (res.show_fr || typeof res.show_fr === 'undefined') {
      ...
      element.textContent = chrome.i18n.getMessage('frenchName');
      popup.appendChild(element);
    }
    ...
    if (res.show_de || typeof res.show_de === 'undefined') {
      ...
      element.textContent = chrome.i18n.getMessage('germanName');
      popup.appendChild(element);
    }
    ...
    if (res.show_el || typeof res.show_el === 'undefined') {
      ...
      element.textContent = chrome.i18n.getMessage('greekName');
      popup.appendChild(element);
    }
    ...
    if (res.show_he || typeof res.show_he === 'undefined') {
      ...
      element.textContent = chrome.i18n.getMessage('hebrewName');
      popup.appendChild(element);
    }
    ...
    if (res.show_hi || typeof res.show_hi === 'undefined') {
      ...
      element.textContent = chrome.i18n.getMessage('hindiName');
      popup.appendChild(element);
    }
    ...
    if (res.show_it || typeof res.show_it === 'undefined') {
      ...
      element.textContent = chrome.i18n.getMessage('italianName');
      popup.appendChild(element);
    }
    ...
    if (res.show_ja || typeof res.show_ja === 'undefined') {
      ...
      element.textContent = chrome.i18n.getMessage('japaneseName');
      popup.appendChild(element);
    }
    ...
    if (res.show_ko || typeof res.show_ko === 'undefined') {
      ...
      element.textContent = chrome.i18n.getMessage('koreanName');
      popup.appendChild(element);
    }
    ...
    if (res.show_pt || typeof res.show_pt === 'undefined') {
      ...
      element.textContent = chrome.i18n.getMessage('portugueseName');
      popup.appendChild(element);
    }
    ...
    if (res.show_ru || typeof res.show_ru === 'undefined') {
      ...
      element.textContent = chrome.i18n.getMessage('russianName');
      popup.appendChild(element);
    }
    ...
    if (res.show_es || typeof res.show_es === 'undefined') {
      ...
      element.textContent = chrome.i18n.getMessage('spanishName');
      popup.appendChild(element);
    }
  });
});
